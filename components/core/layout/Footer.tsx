      ...
      <footer className="bg-gray-800" aria-labelledby="footerHeading">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
            <div>
              <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Like what you read?</h3>
              <p className="mt-2 text-base text-gray-300">
                I also occassionally write on my newsletter, so you may want to subscribe to my newsletter.
              </p>
            </div>
            <form
              className="mt-4 sm:flex sm:max-w-md lg:mt-0"
              action="https://buttondown.email/api/emails/embed-subscribe/ericjiang97"
              method="POST"
            >
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              ...
              <p className="mt-2 md:mt-0">Powered by Vercel, Built with NextJS and Tailwind</p>
            </div>
          </div>
        </div>
      </footer>
